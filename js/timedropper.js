            ...
            _td_overlay.click(function() {
                ...
                _td_event = setTimeout(function() {
                    _td_container.removeClass('td-show')
                      ...
                      // Добавляю кнопку для годинника
                    // confirm(document.querySelector('.time_input').value);
                    if(confirm("Ви вибрали час:"+" "+document.querySelector('.time_input').value)){
                         // хочу получить клас щоб вішать собитие на сonfirm
                        // alert(document.querySelector('#time').className.substr(11,10));
                        if(document.querySelector('#time').className.substr(11,10)=="setTime_6 "){
                            document.querySelector('.get_time_table1').value = document.querySelector('#time').value;
                            // alert(document.querySelector('.get_time_table1').value);
                        }if(document.querySelector('#time').className.substr(11,10)=="setTime_30"){
                            document.querySelector('.get_time_table2').value = document.querySelector('#time').value;
                        }if(document.querySelector('#time').className.substr(11,10)=="setTime_7 "){
                            document.querySelector('.get_time_table3').value = document.querySelector('#time').value;
                        }if(document.querySelector('#time').className.substr(11,10)=="setTime_8 "){
                            document.querySelector('.get_time_table4').value = document.querySelector('#time').value;
                        }if(document.querySelector('#time').className.substr(11,10)=="setTime_9 "){
                            document.querySelector('.get_time_table5').value = document.querySelector('#time').value;
                        }if(document.querySelector('#time').className.substr(11,10)=="setTime_10"){
